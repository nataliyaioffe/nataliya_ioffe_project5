...
class SortResult extends Component {
  ...
  render() {
    ...
    return <section id="sort-page">
        {this.state.currentPage === "sortResult" ? <div className="sort-result">
            <p class={this.state.anim1 === true ? "anim1" : "hide"}>
              Hmm...
            </p>
            ...
            <p className={this.state.anim3 === true ? "anim3" : "hide"}>
              <span
                className={"result-house" + " " + this.props.userHouseName}
              >
